...
export default function MainHero({ children, hero }) {
  const heroData = {
    ...
    'top-line-growth': {
      ...
      subtitle:
        'Clyde Ventures’ mission is to create social mobility by delivering top line growth for our clients. We teach organisations how to fish in new waters using the following range of solutions.',
    },
    'service-excellence': {
